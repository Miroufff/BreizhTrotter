...
class ImageController extends Controller
{
    ...
    public function createAction(Request $request)
    {
        ...
        if ($form->isValid()) {
            ...
            return $this->redirect($this->generateUrl('ens_image_show', array('id' => $entity->getId())));
        }
    ...
    private function createCreateForm(Image $entity)
    {
        $form = $this->createForm(new ImageType(), $entity, array(
            'action' => $this->generateUrl('ens_image_create'),
            'method' => 'POST',
        ));
    ...
    */
    ...
    {
        $form = $this->createForm(new ImageType(), $entity, array(
            'action' => $this->generateUrl('ens_image_update', array('id' => $entity->getId())),
            'method' => 'PUT',
        ));
    ...
    public function updateAction(Request $request, $id)
    {
        ...
        if ($editForm->isValid()) {
            ...
            return $this->redirect($this->generateUrl('ens_image_edit', array('id' => $id)));
        }
    ...
    public function deleteAction(Request $request, $id)
    {
        ...
        return $this->redirect($this->generateUrl('ens_image'));
    }
    ...
    private function createDeleteForm($id)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('ens_image_delete', array('id' => $id)))
            ->setMethod('DELETE')
