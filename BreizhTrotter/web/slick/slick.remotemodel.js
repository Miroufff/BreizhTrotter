...
//            }
            ...
            var url = pUrlbase + '/' + lastPage;

//           var url = pUrlbase + "?filter[fields][type][]=submission&q=" + searchstr + "&start=" + (fromPage * PAGESIZE) + "&limit=" + (((toPage - fromPage) * PAGESIZE) + PAGESIZE);
//
//            if (sortcol != null) {
...
//
            ...
            data.length = Math.min(parseInt(resp.hits),1000);
